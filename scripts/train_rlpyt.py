...
from learn_seq.utils.rlpyt import (CustomTrajInfo, gym_make,
                                   load_agent_state_dict)
...
def build_and_train(config, agent_state_dict=None):
    ...
    sampler = SamplerCls(EnvCls=gym_make,
                         TrajInfoCls=CustomTrajInfo,
                         env_kwargs=env_kwargs,
                         eval_env_kwargs=env_kwargs,
                         **sampler_kwargs)  # NOTE CpuResetCollector
    ...
    run_config = dict(env_config=env_kwargs,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--env",
                        ...
                        default="round",
                        help="\"round\", \"square\"")
    parser.add_argument("--cpu_offset",
                        "-c",
                        type=int,
                        default=0,
