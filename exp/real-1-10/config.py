...
# T_HOLE = np.array([0.998943,0.0451998,0.00710398,0,0.0450539,-0.998784,0.0195068,0,0.0079772,-0.0191665,-0.999784,0,\
#                    0.530577,0.0789321,0.143805,1]).reshape((4, 4)).T
...
KD_ADMITTANCE_ROT_RANGE = [0.05, 0.15]
...
# admittance
stiffness =[500, 500, 500, 50, 50, 30.]
damping = [10.]*6
for j in range(NO_QUANTIZATION):
...
env_config = {
    ...
    "initial_pos_range": ([-0.001]*2+ [-0.0], [0.001]*2+ [0.0]),
