...
from learn_seq.envs.wrapper import StructuredActionSpaceWrapper, QuaternionObservationWrapper
...
env_config = {
    ...
    "wrapper": [StructuredActionSpaceWrapper,QuaternionObservationWrapper],
    "wrapper_kwargs": [{
