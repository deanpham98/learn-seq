...
# T_HOLE = np.array([0.983301,0.181931,0.000571636,0,0.18193,-0.9833,0.00202018,0,0.00092964,-0.00188248,-0.999998, 0,\
#                    0.530961,0.0748913,0.152993,1]).reshape((4, 4)).T
